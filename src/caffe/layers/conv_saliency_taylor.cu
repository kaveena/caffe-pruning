...
template void ConvolutionSaliencyLayer<float>::compute_taylor_gpu(const float *  act_data, const float *  act_diff, float * taylor);
template void ConvolutionSaliencyLayer<double>::compute_taylor_gpu(const double *  act_data, const double *  act_diff, double * taylor);

template void ConvolutionSaliencyLayer<float>::compute_taylor_weights_gpu(Blob<float> * weights_n, Blob<float> * bias_n, float * taylor);
template void ConvolutionSaliencyLayer<double>::compute_taylor_weights_gpu(Blob<double> * weights_n, Blob<double> * bias_n, double * taylor);
}  // namespace caffe
