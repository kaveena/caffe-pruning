...
void ConvolutionSaliencyLayer<Dtype>::compute_taylor_gpu(const Dtype *  act_data, const Dtype *  act_diff, const Dtype * input_data, const Dtype * input_diff,  Dtype * taylor_out, Dtype * taylor_in) {
...
template <typename Dtype>
void ConvolutionSaliencyLayer<Dtype>::compute_taylor_weights_gpu(Blob<Dtype> * weights_n, Blob<Dtype> * bias_n, Dtype * taylor_out, Dtype * taylor_in) {
...
template void ConvolutionSaliencyLayer<float>::compute_taylor_gpu(const float *  act_data, const float *  act_diff, const float * input_data, const float * input_diff,  float * taylor_out, float * taylor_in);
template void ConvolutionSaliencyLayer<double>::compute_taylor_gpu(const double *  act_data, const double *  act_diff, const double * input_data, const double * input_diff,  double * taylor_out, double * taylor_in);

template void ConvolutionSaliencyLayer<float>::compute_taylor_weights_gpu(Blob<float> * weights_n, Blob<float> * bias_n, float * taylor_out, float * taylor_in);
template void ConvolutionSaliencyLayer<double>::compute_taylor_weights_gpu(Blob<double> * weights_n, Blob<double> * bias_n, double * taylor_out, double * taylor_in);
}  // namespace caffe
