...
void ConvolutionLayer<Dtype>::compute_taylor_cpu(const Dtype *  act_data, const Dtype *  act_diff, Dtype * taylor) {
...
template <typename Dtype>
void ConvolutionLayer<Dtype>::compute_taylor_weights_cpu(Blob<Dtype> * weights_n, Blob<Dtype> * bias_n, Dtype * taylor) {
...
template void ConvolutionLayer<float>::compute_taylor_cpu(const float *  act_data, const float *  act_diff, float * taylor);
template void ConvolutionLayer<double>::compute_taylor_cpu(const double *  act_data, const double *  act_diff, double * taylor);

template void ConvolutionLayer<float>::compute_taylor_weights_cpu(Blob<float> * weights_n, Blob<float> * bias_n, float * taylor);
template void ConvolutionLayer<double>::compute_taylor_weights_cpu(Blob<double> * weights_n, Blob<double> * bias_n, double * taylor);
}  // namespace caffe
