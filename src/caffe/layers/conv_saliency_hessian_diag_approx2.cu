...
void ConvolutionLayer<Dtype>::compute_hessian_diag_approx2_gpu(const Dtype * bottom_data, const Dtype * bottom_diff, const Dtype * top_data, const Dtype * top_diff, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, Dtype * hessian_diag_in, Dtype * hessian_diag_out) {
...
template <typename Dtype>
void ConvolutionLayer<Dtype>::compute_hessian_diag_approx2_weights_gpu(Blob<Dtype> * weights_n, Blob<Dtype> * bias_n, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, Dtype * hessian_diag_in, Dtype * hessian_diag_out) {
...
template void ConvolutionLayer<float>::compute_hessian_diag_approx2_gpu(const float * bottom_data, const float * bottom_diff, const float * top_data, const float * top_diff, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, float * hessian_diag_in, float * hessian_diag_out);
template void ConvolutionLayer<double>::compute_hessian_diag_approx2_gpu(const double * bottom_data, const double * bottom_diff, const double * top_data, const double * top_diff, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, double * hessian_diag_in, double * hessian_diag_out);

template void ConvolutionLayer<float>::compute_hessian_diag_approx2_weights_gpu(Blob<float> * weights_n, Blob<float> * bias_n, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, float * hessian_diag_in, float * hessian_diag_out);
template void ConvolutionLayer<double>::compute_hessian_diag_approx2_weights_gpu(Blob<double> * weights_n, Blob<double> * bias_n, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, double * hessian_diag_in, double * hessian_diag_out);
}  // namespace caffe
