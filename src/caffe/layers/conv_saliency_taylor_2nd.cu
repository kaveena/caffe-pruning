...
template <typename Dtype>
void ConvolutionLayer<Dtype>::compute_taylor_2nd_gpu(const Dtype * bottom_data, const Dtype * bottom_diff, const Dtype * bottom_ddiff, const Dtype * top_data, const Dtype * top_diff, const Dtype * top_ddiff, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, Dtype * taylor_2nd_in, Dtype * taylor_2nd_out) {
...
template void ConvolutionLayer<float>::compute_taylor_2nd_gpu(const float * bottom_data, const float * bottom_diff, const float * bottom_ddiff, const float * top_data, const float * top_diff, const float * top_ddiff, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, float * taylor_2nd_in, float * taylor_2nd_out);
template void ConvolutionLayer<double>::compute_taylor_2nd_gpu(const double * bottom_data, const double * bottom_diff, const double * bottom_ddiff, const double * top_data, const double * top_diff, const double * top_ddiff, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, double * taylor_2nd_in, double * taylor_2nd_out);
