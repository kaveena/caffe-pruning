...
template <typename Dtype>
void ConvolutionLayer<Dtype>::compute_taylor_2nd_gpu(const Dtype * bottom_data, const Dtype * bottom_diff, Dtype * bottom_ddiff, const * top_data, const Dtype * top_diff, Dtype * top_ddiff, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, Dtype * taylor_2nd_in, Dtype * taylor_2nd_out) {
  ...
  compute_norm_and_batch_avg_gpu(input_saliency_data, output_saliency_data, saliency_norm_, taylor_2nd_in, taylor_2nd_out);
}

template <typename Dtype>
void ConvolutionLayer<Dtype>::compute_taylor_2nd_weights_gpu(Blob<Dtype> * weights_n, Blob<Dtype> * bias_n, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, Dtype * taylor_2nd_in, Dtype * taylor_2nd_out) {
  ...
  compute_norm_and_batch_avg_weights_gpu(points_saliency_data, bias_saliency_data, saliency_norm_, taylor_2nd_in, taylor_2nd_out);
}

template void ConvolutionLayer<float>::compute_taylor_2nd_gpu(const float * bottom_data, const float * bottom_diff, float * bottom_ddiff, const * top_data, const float * top_diff, float * top_ddiff, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, float * taylor_2nd_in, float * taylor_2nd_out);
template void ConvolutionLayer<double>::compute_taylor_2nd_gpu(const double * bottom_data, const double * bottom_diff, double * bottom_ddiff, const * top_data, const double * top_diff, double * top_ddiff, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, double * taylor_2nd_in, double * taylor_2nd_out);

template void ConvolutionLayer<float>::compute_taylor_2nd_weights_gpu(Blob<float> * weights_n, Blob<float> * bias_n, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, float * taylor_2nd_in, float * taylor_2nd_out);
template void ConvolutionLayer<double>::compute_taylor_2nd_weights_gpu(Blob<double> * weights_n, Blob<double> * bias_n, caffe::ConvolutionSaliencyParameter::NORM saliency_norm_, double * taylor_2nd_in, double * taylor_2nd_out);
}  // namespace caffe
