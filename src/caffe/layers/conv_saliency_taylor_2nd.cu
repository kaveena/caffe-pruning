...
template void ConvolutionSaliencyLayer<float>::compute_taylor_2nd_gpu(const float *  act_data, const float * act_diff, const float *  act_ddiff, float * taylor_2nd);
template void ConvolutionSaliencyLayer<double>::compute_taylor_2nd_gpu(const double *  act_data, const double * act_diff, const double *  act_ddiff, double * taylor_2nd);

template void ConvolutionSaliencyLayer<float>::compute_taylor_2nd_weights_gpu(Blob<float> * weights_n, Blob<float> * bias_n, float * taylor_2nd);
template void ConvolutionSaliencyLayer<double>::compute_taylor_2nd_weights_gpu(Blob<double> * weights_n, Blob<double> * bias_n, double * taylor_2nd);
}  // namespace caffe
