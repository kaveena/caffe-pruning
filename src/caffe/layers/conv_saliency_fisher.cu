...
void ConvolutionLayer<Dtype>::compute_fisher_gpu(const Dtype *  act_data, const Dtype *  act_diff, Dtype * fisher_info) {
...
template <typename Dtype>
void ConvolutionLayer<Dtype>::compute_fisher_weights_gpu(Blob<Dtype> * weights_n, Blob<Dtype> * bias_n, Dtype * fisher_info) {
...
template void ConvolutionLayer<float>::compute_fisher_gpu(const float *  act_data, const float *  act_diff, float * fisher_info);
template void ConvolutionLayer<double>::compute_fisher_gpu(const double *  act_data, const double *  act_diff, double * fisher_info);

template void ConvolutionLayer<float>::compute_fisher_weights_gpu(Blob<float> * weights_n, Blob<float> * bias_n, float * fisher_info);
template void ConvolutionLayer<double>::compute_fisher_weights_gpu(Blob<double> * weights_n, Blob<double> * bias_n, double * fisher_info);
}  // namespace caffe
