...
void ConvolutionLayer<Dtype>::compute_weight_avg_cpu(const Dtype *  act_data, Dtype * saliency_info) {
...
template <typename Dtype>
void ConvolutionLayer<Dtype>::compute_weight_avg_weights_cpu(Blob<Dtype> * weights_n, Blob<Dtype> * bias_n, Dtype * saliency_info) {
...
template <typename Dtype>
void ConvolutionLayer<Dtype>::compute_diff_avg_cpu(const Dtype *  act_diff, Dtype * saliency_info) {
  Dtype* output_saliency_data = output_saliencies_points_.mutable_cpu_data();
...
template <typename Dtype>
void ConvolutionLayer<Dtype>::compute_diff_avg_weights_cpu(Blob<Dtype> * weights_n, Blob<Dtype> * bias_n, Dtype * saliency_info) {
...
template void ConvolutionLayer<float>::compute_weight_avg_cpu(const float *  act_data, float * saliency_info);
template void ConvolutionLayer<double>::compute_weight_avg_cpu(const double *  act_data, double * saliency_info);

template void ConvolutionLayer<float>::compute_weight_avg_weights_cpu(Blob<float> * weights_n, Blob<float> * bias_n, float * saliency_info);
template void ConvolutionLayer<double>::compute_weight_avg_weights_cpu(Blob<double> * weights_n, Blob<double> * bias_n, double * saliency_info);

template void ConvolutionLayer<float>::compute_diff_avg_cpu(const float *  act_diff, float * saliency_info);
template void ConvolutionLayer<double>::compute_diff_avg_cpu(const double *  act_diff, double * saliency_info);

template void ConvolutionLayer<float>::compute_diff_avg_weights_cpu(Blob<float> * weights_n, Blob<float> * bias_n, float * saliency_info);
template void ConvolutionLayer<double>::compute_diff_avg_weights_cpu(Blob<double> * weights_n, Blob<double> * bias_n, double * saliency_info);
