...
void ConvolutionSaliencyLayer<Dtype>::compute_weight_avg_gpu(const Dtype *  act_data, const Dtype * input_data, Dtype * saliency_info_out, Dtype * saliency_info_in) {
...
template <typename Dtype>
void ConvolutionSaliencyLayer<Dtype>::compute_weight_avg_weights_gpu(Blob<Dtype> * weights_n, Blob<Dtype> * bias_n, Dtype * saliency_info_out, Dtype * saliency_info_in) {
...
template <typename Dtype>
void ConvolutionSaliencyLayer<Dtype>::compute_diff_avg_gpu(const Dtype *  act_diff, const Dtype * input_diff, Dtype * saliency_info_out, Dtype * saliency_info_in) {
  Dtype* output_saliency_data = NULL;    
  Dtype* input_saliency_data = NULL;    
  if (this->output_channel_saliency_compute_) {
    output_saliency_data = output_saliencies_points_.mutable_gpu_data();    
...
template <typename Dtype>
void ConvolutionSaliencyLayer<Dtype>::compute_diff_avg_weights_gpu(Blob<Dtype> * weights_n, Blob<Dtype> * bias_n, Dtype * saliency_info_out, Dtype * saliency_info_in) {
...
template void ConvolutionSaliencyLayer<float>::compute_weight_avg_gpu(const float *  act_data, const float * input_data, float * saliency_info_out, float * saliency_info_in);
template void ConvolutionSaliencyLayer<double>::compute_weight_avg_gpu(const double *  act_data, const double * input_data, double * saliency_info_out, double * saliency_info_in);

template void ConvolutionSaliencyLayer<float>::compute_weight_avg_weights_gpu(Blob<float> * weights_n, Blob<float> * bias_n, float * saliency_info_out, float * saliency_info_in);
template void ConvolutionSaliencyLayer<double>::compute_weight_avg_weights_gpu(Blob<double> * weights_n, Blob<double> * bias_n, double * saliency_info_out, double * saliency_info_in);

template void ConvolutionSaliencyLayer<float>::compute_diff_avg_gpu(const float *  act_diff, const float * input_diff, float * saliency_info_out, float * saliency_info_in);
template void ConvolutionSaliencyLayer<double>::compute_diff_avg_gpu(const double *  act_diff, const double * input_diff, double * saliency_info_out, double * saliency_info_in);

template void ConvolutionSaliencyLayer<float>::compute_diff_avg_weights_gpu(Blob<float> * weights_n, Blob<float> * bias_n, float * saliency_info_out, float * saliency_info_in);
template void ConvolutionSaliencyLayer<double>::compute_diff_avg_weights_gpu(Blob<double> * weights_n, Blob<double> * bias_n, double * saliency_info_out, double * saliency_info_in);
