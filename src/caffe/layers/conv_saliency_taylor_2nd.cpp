...
void ConvolutionSaliencyLayer<Dtype>::compute_taylor_2nd_cpu(const Dtype *  act_data, const Dtype * act_diff, const Dtype *  act_ddiff, const Dtype * input_data, const Dtype * input_diff, const Dtype * input_ddiff, Dtype * taylor_2nd_out, Dtype * taylor_2nd_in) {
...
template <typename Dtype>
void ConvolutionSaliencyLayer<Dtype>::compute_taylor_2nd_weights_cpu(Blob<Dtype> * weights_n, Blob<Dtype> * bias_n, Dtype * taylor_2nd_out, Dtype * taylor_2nd_in) {
...
template void ConvolutionSaliencyLayer<float>::compute_taylor_2nd_cpu(const float *  act_data, const float * act_diff, const float *  act_ddiff, const float * input_data, const float * input_diff, const float * input_ddiff, float * taylor_2nd_out, float * taylor_2nd_in);
template void ConvolutionSaliencyLayer<double>::compute_taylor_2nd_cpu(const double *  act_data, const double * act_diff, const double *  act_ddiff, const double * input_data, const double * input_diff, const double * input_ddiff, double * taylor_2nd_out, double * taylor_2nd_in);

template void ConvolutionSaliencyLayer<float>::compute_taylor_2nd_weights_cpu(Blob<float> * weights_n, Blob<float> * bias_n, float * taylor_2nd_out, float * taylor_2nd_in);
template void ConvolutionSaliencyLayer<double>::compute_taylor_2nd_weights_cpu(Blob<double> * weights_n, Blob<double> * bias_n, double * taylor_2nd_out, double * taylor_2nd_in);
}  // namespace caffe
