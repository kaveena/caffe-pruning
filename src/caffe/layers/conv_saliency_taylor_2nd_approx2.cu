...
void ConvolutionLayer<Dtype>::compute_taylor_2nd_approx2_gpu(const Dtype *  act_data, const Dtype * act_diff, Dtype * taylor_2nd) {
...
template <typename Dtype>
void ConvolutionLayer<Dtype>::compute_taylor_2nd_approx2_weights_gpu(Blob<Dtype> * weights_n, Blob<Dtype> * bias_n, Dtype * taylor_2nd) {
...
template void ConvolutionLayer<float>::compute_taylor_2nd_approx2_gpu(const float *  act_data, const float * act_diff, float * taylor_2nd);
template void ConvolutionLayer<double>::compute_taylor_2nd_approx2_gpu(const double *  act_data, const double * act_diff, double * taylor_2nd);

template void ConvolutionLayer<float>::compute_taylor_2nd_approx2_weights_gpu(Blob<float> * weights_n, Blob<float> * bias_n, float * taylor_2nd);
template void ConvolutionLayer<double>::compute_taylor_2nd_approx2_weights_gpu(Blob<double> * weights_n, Blob<double> * bias_n, double * taylor_2nd);
}  // namespace caffe
